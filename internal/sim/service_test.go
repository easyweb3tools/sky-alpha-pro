...
func setupSimTestDB(t *testing.T) *gorm.DB {
	...
	ddls := []string{
		`CREATE TABLE markets (
			...
			spec_status TEXT DEFAULT 'incomplete',
		...
		`CREATE TABLE signals (
			...
			edge_exec_pct DECIMAL(8,4) DEFAULT 0,
			confidence DECIMAL(5,2) DEFAULT 0,
			market_price DECIMAL(10,4) DEFAULT 0,
			market_price_executable DECIMAL(10,4) DEFAULT 0,
			our_estimate DECIMAL(10,4) DEFAULT 0,
			friction_pct DECIMAL(8,4) DEFAULT 0,
